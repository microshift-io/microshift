...
COPY --chmod=755 ./src/scripts/create_repos.sh ${REPO_CONFIG_SCRIPT}
COPY --chmod=755 ./src/scripts/configure.sh ${OKD_CONFIG_SCRIPT}
...
COPY ./src/systemd/microshift-make-rshared.service /etc/systemd/system/microshift-make-rshared.service
