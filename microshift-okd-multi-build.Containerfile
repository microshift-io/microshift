...
COPY ./microshift-upstream/src /src
...
COPY --chmod=755 ./microshift-upstream/src/create_repos.sh ${REPO_CONFIG_SCRIPT}
COPY --chmod=755 ./microshift-upstream/src/configure.sh ${OKD_CONFIG_SCRIPT}
